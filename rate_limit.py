"""
    ...
    https://github.com/sns-sdks/python-twitter/blob/master/pytwitter/rate_limit.py
    e9bc4e7
"""
...
class RateLimit:
    ...
    @staticmethod
    def url_to_endpoint(url: httpx.URL) -> Endpoint:
        resource = url.path.replace("/2", "", 1)  # only replace api version
